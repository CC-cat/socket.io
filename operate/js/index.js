...
var _videoPageBtn = function() {
    $("._btnOpacity li").eq(0).fadeTo("slow", 0.05);
    $("._btnOpacity li").eq(1).fadeTo("slow", 0.10);
    $("._btnOpacity li").eq(2).fadeTo("slow", 0.15);
    $("._btnOpacity li").eq(3).fadeTo("slow", 0.20);
    $("._btnOpacity li").eq(4).fadeTo("slow", 0.25);
    $("._btnOpacity li").eq(5).fadeTo("slow", 0.30);
    $("._btnOpacity li").eq(6).fadeTo("slow", 0.35);
}
